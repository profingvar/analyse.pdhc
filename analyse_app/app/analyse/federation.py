...
def fanout(
    ...
    *,
    ...
    if bearer_token:
        ...
        # Fall back to analyse's outbound service-key — the CDRs
        # accept "analyse.pdhc" via their KNOWN_FHIR_SERVICES table.
        try:
            from flask import current_app
            sk = current_app.config.get("ANALYSE_PDHC_SERVICE_KEY", "")
        except RuntimeError:
            sk = ""
        if sk:
            headers["X-Source-Service"] = "analyse.pdhc"
